...
/**
 * Implement this interface on TileEntities which should connect to item
...
public interface IInventoryConnection
{
	 ...
	 * @return DEFAULT if the connector should decide how to connect; FORCE if
	 *         the connector should always connect; DENY if the connector should
	 *         never connect.
	 */
