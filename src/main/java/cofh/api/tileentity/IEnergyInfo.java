...
/**
 * Implement this interface on objects which can report information about their
 * energy usage.
 *
 * This is used for reporting purposes - Energy transactions are handled via the
 * RF API!
 *
 * @author King Lemming
 */
