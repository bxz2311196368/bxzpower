...
/**
 * Implemented on objects which support Augments - these are modular and
 * removable items which provide boosts or alterations to functionality.
 *
 * Effects of this are determined by the object itself and should be checked vs
 * the Augment Type denoted in {@link IAugmentItem}.
 *
 * @author King Lemming
 */
public interface IAugmentable
{
	...
	/**
	 * Updates the status of Augments in the (Tile) Entity. Should be called to
