...
public interface ISecurable
{
	...
	/**
	 * Enum for Access Modes - TeamOnly allows Team access, FriendsOnly is
	 * Friends Only, Private is Owner only.
	 *
	 * @author King Lemming
	 */
	enum AccessMode {
		...
		public static AccessMode stepBackward(AccessMode curAccess)
		{
			...
			return curAccess == PUBLIC ? PRIVATE
					: curAccess == PRIVATE ? FRIENDS : curAccess == FRIENDS ? TEAM : PUBLIC;
		}
	}
