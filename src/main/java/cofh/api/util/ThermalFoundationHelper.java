...
/**
 * The purpose of this class is to show how to use and provide an interface for
 * Thermal Foundation's IMC Lexicon Blacklist manipulation.
 *
 * This is really the only safe way to do this. Please do not attempt any direct
