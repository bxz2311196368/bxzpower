...
/**
 * Implement this interface on Item classes which have multiple modes - what
 * that means is completely up to you. This just provides a uniform way of
 * dealing with them.
 *
 * @author King Lemming
 */
public interface IMultiModeItem
{
	...
	/**
	 * Callback method for reacting to a state change. Useful in KeyBinding
	 * handlers.
	 *
	 * @param player
