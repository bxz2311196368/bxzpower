...
public interface IAugmentItem
{
	 ...
	 *
	 * BASIC - Standard augment, can have multiple. ADVANCED - Rare augment,
	 * multiples may or may not be allowed. MODE - Changes functionality
	 * greatly. Only allow one. ENDER - Integration with Ender Frequencies.
	...
	/**
	 * Get the Augment Identifier for a given Augment. This is simply a string
	 * with some description of what the Augment does. Individual
	 *
	 * @param stack
	 *            ItemStack representing the Augment.
	 * @return Augment Type of the stack.
