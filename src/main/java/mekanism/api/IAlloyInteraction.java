...
/**
 * Implement this class in your TileEntity if it can interact with Mekanism
 * alloys.
 * 
 * @author aidancbrady
 *
...
public interface IAlloyInteraction
{
	 ...
	 * @param hand
	 *            - the hand this alloy was right-clicked with
	 * @param stack
	 *            - the stack of alloy being right-clicked
	 * @param tierOrdinal
	 *            - the ordinal tier of the alloy (1 = advanced, 2 = elite, 3 =
	 *            ultimate)
	 */
