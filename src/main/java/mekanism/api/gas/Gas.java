...
/**
 * Gas - a class used to set specific properties of gasses when used or seen
 * in-game.
 * 
 * @author aidancbrady
 *
...
public class Gas
{
	 ...
	 * 
	 * @param s
	 *            - name or key to associate this Gas with
	 */
	...
	/**
	 * Gets the name (key) of this Gas. This is NOT a translated or localized
	 * display name.
	 * 
	...
	/**
	 * Sets this gas's "visible" state to a new value. Setting it to 'false'
	 * will treat this gas as an internal gas, and it will not be displayed or
	 * accessed by other mods.
	 * 
	 * @param v
	 *            - new visible state
	 ...
	 * 
	 * @param i
	 *            - IIcon to associate with this Gas
	 * @return this Gas object
	 */
	 ...
	 * 
	 * @param nbtTags
	 *            - tag compound to get the Gas from
