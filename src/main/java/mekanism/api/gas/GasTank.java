...
/**
 * An optional way of managing and/or storing gasses. Would be very useful in
 * TileEntity and Entity gas storage.
 * 
 * @author aidancbrady
 *
 */
public class GasTank
{
	 ...
	 * 
	 * @param max
	 *            - the maximum amount of gas this GasTank can hold
	 */
	...
	/**
	 * Sets this tank's GasStack value to a new value. Will cap the amount to
	 * this GasTank's capacity.
	 * 
	 * @param stack
	 ...
	 *            - amount to draw
	 * @param doDraw
	 *            - if the gas should actually be removed from this tank
	 ...
	 * 
	 * @param amount
	 *            - the GasStack for this tank to receive
	 * @param doReceive
	 *            - if the gas should actually be added to this tank
	...
	/**
	 * If this GasTank can receive the specified type of gas. Will return false
	 * if this tank does not need anymore gas.
	 * 
	 * @param gas
	 *            - gas to check
	...
	/**
	 * If this GasTank can receive the specified type of gas. Will return TRUE
	 * if this tank does not need anymore gas.
	 * 
	 * @param gas
	 *            - gas to check
	...
	/**
	 * If this GasTank can be drawn of the specified type of gas. Will return
	 * false if this tank does not contain any gas.
	 * 
	 * @param gas
	 *            - gas to check
	...
	/**
	 * Returns the tank stored in the defined tag compound, or null if it
	 * doesn't exist.
	 * 
	 * @param nbtTags
	 *            - tag compound to read from
