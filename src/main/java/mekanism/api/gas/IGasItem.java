...
public interface IGasItem
{
	 ...
	 * @param type
	 *            - the type of gas the tank can possibly receive
	 ...
	 *            - the itemstack to check
	 * @param type
	 *            - the type of gas the tank can provide
	 ...
	 *            - type of gas
	 * @param data
	 *            - ItemStack parameter if necessary
	 * @return gas stored
	 */
