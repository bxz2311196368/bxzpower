...
public class GasStack
{
	 ...
	 * 
	 * @param id
	 *            - gas ID to associate this GasStack to, will perform a
	 *            GasRegistry lookup in the constructor
	 * @param quantity
	 *            - amount of gas to be referenced in this GasStack
	 */
	...
	/**
	 * Returns the GasStack stored in the defined tag compound, or null if it
	 * doesn't exist.
	 * 
	 * @param nbtTags
	 *            - tag compound to read from
	...
	/**
	 * Whether or not this GasStack's gas type is equal to the other defined
	 * GasStack.
	 * 
	 * @param stack
	 *            - GasStack to check
