...
public interface IEnergizedItem
{
	 ...
	 * 
	 * @param itemStack
	 *            - the ItemStack who's energy value is to be change
	 * @param amount
	...
	/**
	 * Gets and returns how much energy this item can transfer to and from
	 * charging slots.
	 * 
	 * @param itemStack
	 *            - the ItemStack to check
	...
	/**
	 * Gets and returns whether or not this item can receive energy from a
	 * charging slot.
	 * 
	 * @param itemStack
	 *            - the ItemStack to check
	...
	/**
	 * Gets and returns whether or not this item can send energy to a charging
	 * slot.
	 * 
	 * @param itemStack
	 *            - the ItemStack to check
