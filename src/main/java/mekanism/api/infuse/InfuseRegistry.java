...
public class InfuseRegistry
{
	 ...
	 * 
	 * @param name
	 *            - the name of the InfuseType to get
	...
	/**
	 * Whether or not the registry contains a correspondent InfuseType to a
	 * name.
	 * 
	 * @param name
	 *            - the name to check
	...
	/**
	 * Registers a block or item that serves as an infuse object. An infuse
	 * object will store a certain type and amount of infuse, and will deliver
	 * this amount to the Metallurgic Infuser's buffer of infuse. The item's
	 * stack size will be decremented when it is placed in the Metallurgic
	 * Infuser's infuse slot, and the machine can accept the type and amount of
	 * infuse stored in the object.
	 * 
	 * @param itemStack
	 *            - stack the infuse object is linked to -- stack size is
	 *            ignored
	 * @param infuseObject
