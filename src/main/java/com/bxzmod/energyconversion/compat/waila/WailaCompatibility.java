package com.bxzmod.energyconversion.compat.waila;
...
public class WailaCompatibility implements IWailaDataProvider
{
	...
	public static void load(IWailaRegistrar registrar)
	{
		...
		if (!loaded)
		{
			registrar.registerHeadProvider(INSTANCE, PowerBlock.class);
			registrar.registerBodyProvider(INSTANCE, PowerBlock.class);
			registrar.registerTailProvider(INSTANCE, PowerBlock.class);
			loaded = true;
		}
	}
	...
	public static void register()
	{
		...
		FMLInterModComms.sendMessage("Waila", "register",
				"com.bxzmod.energyconversion.compat.waila.WailaCompatibility.load");
	}
